---
title: N8N
description: "Integre a ZapperHub ao N8N"
---

N8N é uma ferramenta poderosa de automação de fluxos e tarefas. A integração da 
ZapperHub no N8N é realizada via Nó de **HTTP Request**, conforme indicado nos
passos a seguir:
...
3. Em **URL**, digite a URL completa de acesso ao recurso (ex: https://api.zapperhub.com/inst_abcdefg123456/messages/text para enviar uma mensagem de texto);
...
que se abre, nomeie o nome da credencial para `ZapperHub Auth` (basta clicar sobre o 
