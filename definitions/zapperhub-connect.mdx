...
1. Acesse a extensão ZapperHub Connect na <a href="https://chromewebstore.google.com/detail/zapperhub-connect/ofpcjjnbbbgpaoaplobmkkflgakggdoe">Chrome Web Store</a>

2. Clique em **Usar no Chrome** e confirme a instalação da extensão.

3. Agora, clique no botão "Extensões" localizado logo após a barra de endereço, e clique
...
a utilizar chave de acesso, será necessário utilizar um aplicativo compatível para 
